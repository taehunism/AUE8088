...
class LoadImagesAndLabels(Dataset):
    ...
    def load_mosaic(self, index):
            ...
            # 4. 두 모달리티를 합쳐 6채널 이미지로 만든 후, 증강 적용
...
class LoadRGBTImagesAndLabels(LoadImagesAndLabels):
    ...
    @staticmethod
    def collate_fn4(batch):
        # Implementation of collate_fn4 for RGBT data
        # Method to reduce batch size to 4
        # 5 items returned from __getitem__: imgs, labels_out, path, shapes, index
