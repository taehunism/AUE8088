...
class KAIST(COCO):
    ...
    def __init__(self, annotation_file=None):
        """
        Initialize KAIST dataset class
        Args:
    ...
    def getAnnIds(self, imgIds=[], catIds=[], areaRng=[], iscrowd=None):
        """
        Return list of annotation IDs matching given criteria
        Args:
            imgIds: List of image IDs
            catIds: List of category IDs
            areaRng: Area range
            iscrowd: Crowd flag
        """
        # ... existing code ...
    ...
    def getImgIds(self, imgIds=[], catIds=[]):
        """
        Return list of image IDs matching given criteria
        Args:
            imgIds: List of image IDs
            catIds: List of category IDs
        """
    ...
    def loadAnns(self, ids=[]):
        """
        Load annotations for given IDs
        Args:
    ...
    def loadImgs(self, ids=[]):
        """
        Load images for given IDs
        Args:
            ids: List of image IDs
        """
        # ... existing code ...

    def convert_text_to_json(self, text_file, json_file):
        """
